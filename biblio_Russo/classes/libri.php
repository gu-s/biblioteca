...
class libri {
    ...
    function __construct($codice_libro=0, $fkAutore=0, $fkEditore=0, $titolo="", $numero_pagine=0, $prezzo=0.0, $data_di_acquisto='') {
    ...
    public function setData_di_acquisto($data_di_acquisto) {
        $this->data_di_acquisto = $data_di_acquisto;
    }
    ...
    function get($sql){
         ...
         while ($row= mysql_fetch_array($rs)){
             ...
             $lista[]=new libri($row['codice_libro'], $row['autore'],$row['editore'], 
                     $row['titolo'],$row['numero_di_pagine'],
                     $row['prezzo'],$row['data_di_acquisto']);         
